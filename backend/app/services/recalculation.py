...
def preview_recalculation(db, project_id: str, profile: ValidationProfile, candidate_ids: list[str] | None = None) -> dict:
    ...
    for candidate in candidates:
        latest = db.get(KeywordMetricEvidence, candidate.search_volume_evidence_id) if candidate.search_volume_evidence_id else None
        if latest is None:
