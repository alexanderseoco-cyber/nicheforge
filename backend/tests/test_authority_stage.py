...
def test_primary_authority_preserves_coverage_weak_count_and_threshold():
    result = evaluate_primary_authority(
        ...
        observed_depth=3, da_threshold=20, required_weak=1, ideal_weak=2,
