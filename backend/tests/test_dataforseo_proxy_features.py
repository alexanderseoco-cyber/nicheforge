    ...
    class Client:
        async def post(self, path, payload):
            ...
            return {"status_code": 20000, "status_message": "Ok.", "tasks": [{"status_code": 20000, "cost": 0.02, "result": [{"items": [
                {"target": "example.com", "rank": 123, "backlinks": 10, "referring_domains": 4, "referring_main_domains": 3, "referring_ips": 2, "referring_subnets": 2, "referring_domains_nofollow": 1, "referring_main_domains_nofollow": 1, "backlinks_spam_score": 5},
                {"target": "other.com", "rank": 456, "backlinks": 20, "referring_domains": 8, "referring_main_domains": 7}
            ]}]}]}
    provider = DataForSEOBacklinkSummaryProvider("login", "password", enabled=True, live_approved=True)
